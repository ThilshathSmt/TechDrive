...
import AdminSidebar from "../shared/AdminSidebar"; // neon/glass version you added earlier
import Header from "../shared/Header"; // neon/glass header with onMenuClick support
import { X } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";

/**
 * AdminLayout — GearSync dark/neon shell
 * - Desktop: persistent sidebar + header
 * - Mobile: header with hamburger opens sidebar drawer
 * - Matches gradient backdrop used across the app
 */
...
const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen text-white overflow-hidden">
      {/* Backdrop (matches site aesthetic) */}
      ...
      <div className="relative z-10 flex h-screen">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <Header onMenuClick={() => setMobileOpen(true)} title="Admin" />
