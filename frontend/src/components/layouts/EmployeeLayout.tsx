...
import EmployeeSidebar from "../shared/EmployeeSidebar"; // neon/glass version
import Header from "../shared/Header"; // has onMenuClick + title props
import { X } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";

/**
 * EmployeeLayout — GearSync dark/neon shell
 * - Desktop: persistent sidebar + header
 * - Mobile: slide-in drawer triggered from Header
 * - Matches Admin/Customer layouts for consistency
 */
    ...
    <div className="relative min-h-screen text-white overflow-hidden">
      ...
      <div className="relative z-10 flex h-screen">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <Header onMenuClick={() => setMobileOpen(true)} title="Employee" />
